...
toolbox_laynii = ${toolboxdir}/laynii
...
toolboxes: | $(toolbox_tvm) $(toolbox_vista) $(toolbox_spm) $(toolbox_memolab) $(toolbox_gramm) ${toolbox_bids} ${toolbox_laynii}
	echo 'done'

$(toolbox_vista): | ${toolboxdir}
	git clone https://github.com/vistalab/vistasoft $(toolbox_vista)

${toolbox_laynii}: | ${toolboxdir}
	git clone https://github.com/layerfMRI/laynii ${toolbox_laynii}
	cd ${toolbox_laynii} && make all	
